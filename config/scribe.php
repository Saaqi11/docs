...
return [
    ...
    'auth' => [
        // Enable authentication in the documentation.
        'enabled' => true,

        // Set this to true if your API requires authentication by default.
        'default' => false,

        // Use Bearer tokens for authentication.
        'in' => 'bearer',

        // The name of the header for authentication (e.g., Authorization).
        'name' => 'Authorization',

        // Scribe will use this placeholder in example requests.
        'placeholder' => '{YOUR_ACCESS_TOKEN}',

        // Provide information on how to get an access token.
        'extra_info' => 'To authenticate, you need an access token. You can generate one by sending a POST request to the `/api/v1/oauth/generate` endpoint with the required parameters: `clientId`, `clientSecret`, and `scopes`.',
